    ...
    return Scaffold(
      appBar: AppBar(
        title: Row(
          ...
          children: [
            Text('Savings', style: GoogleFonts.outfit(fontWeight: FontWeight.w700, fontSize: 24, color: AppTheme.textDark)),
            const Icon(Icons.trending_up, color: AppTheme.savingsGreen),
          ],
        ),
        toolbarHeight: 80,
      ),
            ...
            return ListView(
              ...
              children: [
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    _buildTopChip('\$${state.totalSaved.toStringAsFixed(2)}', true),
                    _buildTopChip('${records.length} Trips', false, isBlue: true),
                  ],
                ),
                ...
                InkWell(
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text('Save even more', style: GoogleFonts.outfit(fontWeight: FontWeight.bold, fontSize: 18, color: AppTheme.primaryBlue)),
